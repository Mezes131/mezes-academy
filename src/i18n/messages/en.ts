...
export const messagesEn: MessageTree = {
  ...
  billing: {
    ...
    checkout: {
      ...
      subtitle: "Choose a payment method or start your free trial.",
      paymentMethod: "Payment method",
      selectMethod: "Choose an option",
      selectOption: "Choose",
      noMethods: "No payment methods available for your country.",
      ...
      pushDefault: "Confirm the payment on your phone.",
      pushHint: "Your video access will activate after confirmation.",
      widgetPending: "Payment setup in progress.",
