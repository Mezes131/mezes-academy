...
export const messagesEn: MessageTree = {
  ...
  billing: {
    ...
    enterprise: {
      ...
      quoteHint: "For 10+ seats, request a custom quote.",
      quoteSubmit: "Request quote",
      quoteSent: "Request sent. We will get back to you within 2 business days.",
    },
    team: {
      title: "Team",
      subtitle: "Organization: {name}",
      seatsUsed: "{used} / {limit} seats used",
      inviteEmail: "Teammate email",
      invite: "Invite",
      inviteSent: "Invitation sent.",
      remove: "Remove",
      removeConfirm: "Remove this member from the team?",
      noAccess: "You are not part of an Enterprise organization.",
