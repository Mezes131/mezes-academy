...
export const messagesFr = {
  ...
  academy: {
    ...
    contact: {
      ...
      successBody: "On a bien reçu ta demande. Réponse sous 48 h ouvrées.",
      successAgain: "Écrire un autre message",
  ...
  billing: {
    ...
    checkout: {
      ...
      subtitle: "Choisis ton moyen de paiement ou démarre l'essai gratuit.",
      paymentMethod: "Moyen de paiement",
      selectMethod: "Choisir une option",
      selectOption: "Choisir",
      noMethods: "Aucun moyen de paiement disponible pour ton pays.",
      ...
      pushDefault: "Confirme le paiement sur ton téléphone.",
      pushHint: "Ton accès vidéo sera activé dès confirmation.",
      widgetPending: "Paiement en cours de configuration.",
    ...
    enterprise: {
      ...
      quoteHint: "Pour 10 sièges ou plus, demande un devis personnalisé.",
      quoteSubmit: "Demander un devis",
      quoteSent: "Demande envoyée. Nous te recontactons sous 48 h ouvrées.",
    },
    team: {
      title: "Équipe",
      subtitle: "Organisation : {name}",
      seatsUsed: "{used} / {limit} sièges utilisés",
      inviteEmail: "E-mail du collaborateur",
      invite: "Inviter",
      inviteSent: "Invitation envoyée.",
      remove: "Retirer",
      removeConfirm: "Retirer ce membre de l'équipe ?",
      noAccess: "Tu n'appartiens à aucune organisation Enterprise.",
      backBilling: "Retour à la facturation",
      statusActive: "Actif",
      statusPending: "En attente",
      roleAdmin: "Admin",
      roleMember: "Membre",
      memberUser: "Utilisateur {id}",
    },
  },
};
