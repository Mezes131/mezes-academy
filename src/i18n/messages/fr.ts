...
export const messagesFr = {
  ...
  academy: {
    ...
    contact: {
      eyebrow: "Académie",
      title: "Contact",
      lead: "Pas de formulaire, pas de file d'attente : un e-mail suffit.",
      p1: "Pour une question sur un parcours, un compte, ou un changement d'adresse e-mail, écris-nous. On lit, et on répond.",
      p2: "Pas de chatbot, pas de ticket automatique. Si le sujet est urgent, dis-le dans l'objet du message.",
